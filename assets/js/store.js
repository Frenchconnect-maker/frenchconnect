...
/* ====== STICKERS PRO STREET (override) ====== */
.card { position: relative; }

/* Sticker type “label” + petit coin plié */
.sticker{
  ...
  box-shadow:
    ...
    0 0 18px rgba(57,255,20,.22) !important;
...
.sticker.pink{
  ...
  box-shadow:
    0 10px 30px rgba(0,0,0,.35),
    0 0 18px rgba(255,43,214,.20) !important;
}

.sticker.cyan{
  background: var(--neon3) !important;
  box-shadow:
    0 10px 30px rgba(0,0,0,.35),
    0 0 18px rgba(0,229,255,.18) !important;
}
...
/* Optionnel: petit effet “grain” street */
.sticker{
  background-image:
    radial-gradient(rgba(0,0,0,.12) 1px, transparent 1px) !important;
