...
const STORE = [
  {
    ...
    category: "extraits",
    badge: "Rosin",
    desc: "Rosin artisanal, terpènes naturels. THC < 0,3 %.",
    options: [
  ...
  },
  {
    ...
    category: "extraits",
    badge: "Live Rosin",
    desc: "Live rosin premium, série limitée. THC < 0,3 %.",
    options: [
      { id: "1g", label: "1 g", price: 40.00, payment_link: "" },
      { id: "3g", label: "3 g", price: 120.00, payment_link: "" },
      { id: "5g", label: "5 g", price: 200.00, payment_link: "" },
  ...
  },
  {
    ...
    category: "extraits",
    badge: "Live Rosin",
    desc: "Live rosin, profil aromatique gourmand. THC < 0,3 %.",
    options: [
      { id: "1g", label: "1 g", price: 40.00, payment_link: "" },
      { id: "3g", label: "3 g", price: 120.00, payment_link: "" },
      { id: "5g", label: "5 g", price: 200.00, payment_link: "" },
  ...
  },
  {
    ...
    category: "resines",
    badge: "Hash",
    desc: "Résine CBD premium. THC < 0,3 %.",
    options: [
  ...
  },
  {
    ...
    category: "resines",
    badge: "Hash",
    desc: "Résine CBD au profil Amnesia. THC < 0,3 %.",
    options: [
  ...
  },
  {
    ...
    category: "resines",
    badge: "Hash",
    desc: "Résine CBD au profil Blueberry. THC < 0,3 %.",
    options: [
      { id: "1g", label: "1 g", price: 12.00, payment_link: "" },
      { id: "3g", label: "3 g", price: 36.00, payment_link: "" },
      { id: "5g", label: "5 g", price: 60.00, payment_link: "" },
  ...
  },
  {
    ...
    category: "fleurs",
    badge: "Fleur",
    desc: "Fleur CBD premium. THC < 0,3 %.",
    options: [
  ...
  },
  {
    ...
    category: "prerolls",
    badge: "Pre Roll",
    desc: "Pre roll CBD prêt à l’emploi. THC < 0,3 %.",
    payment_link: ""
  },
  {
    ...
    category: "prerolls",
    badge: "Pre Roll",
    desc: "Pre roll premium infusé rosin. THC < 0,3 %.",
    payment_link: ""
  },
  {
