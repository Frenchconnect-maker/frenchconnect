...
const STORE = [
  ...
  // ===== FLEURS FR (Sud-Ouest 🇫🇷) — AVEC REMISES PAR GRAMMAGE =====
  {
    ...
    category: "fleurs",
    badge: "Fleur FR",
    desc: "Fleur CBD cultivée en France (Sud-Ouest) : profil exotique et gourmand, notes ananas / kush, têtes propres et aromatiques. THC < 0,3 %.",
  ...
  },
  {
    ...
    category: "fleurs",
    badge: "Fleur FR",
    desc: "Fleur CBD cultivée en France (Sud-Ouest) : ananas acidulé, aromatique plus vif, sélection clean. THC < 0,3 %.",
    sticker: { text: "FR", tone: "cyan", side: "right" },
  ...
  },
  {
    ...
    category: "fleurs",
    badge: "Fleur FR",
    desc: "Fleur CBD cultivée en France (Sud-Ouest) : profil fruité et rond, têtes soignées, odeur propre. THC < 0,3 %.",
    sticker: { text: "FR", tone: "cyan", side: "right" },
  ...
  },
  {
    ...
    category: "fleurs",
    badge: "Fleur FR",
    desc: "Fleur CBD cultivée en France (Sud-Ouest) : notes d'orange / agrumes, vibe fraîche, sélection clean. THC < 0,3 %.",
    sticker: { text: "FR", tone: "cyan", side: "right" },
  ...
  },
  {
    ...
    category: "fleurs",
    badge: "Fleur FR",
    desc: "Fleur CBD cultivée en France (Sud-Ouest) : notes pêche / fruité doux, têtes propres, aromatique agréable. THC < 0,3 %.",
    sticker: { text: "FR", tone: "cyan", side: "right" },
  ...
  },
  {
    ...
    category: "fleurs",
    badge: "Fleur FR",
    desc: "Fleur CBD cultivée en France (Sud-Ouest) : profil floral / fruité, têtes soignées, odeur nette. THC < 0,3 %.",
    sticker: { text: "FR", tone: "cyan", side: "right" },
    options: buildGramOptions(4.70),
    payment_link: ""
  },
  {
    ...
    category: "fleurs",
    badge: "Fleur FR",
    desc: "Fleur CBD cultivée en France (Sud-Ouest) : génétique Kompolti, profil naturel et herbacé, sélection propre. THC < 0,3 %.",
    sticker: { text: "FR", tone: "cyan", side: "right" },
    options: buildGramOptions(3.90),
    payment_link: ""
  },
